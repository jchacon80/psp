...
public class ParkingCamion {
	...
	static int camionEsperando = 0;
	static int cocheEsperando = 0;
	static final int MAX_CAMIONES = 3;
	static final int MAX_COCHES = 20;
	...
	public static synchronized void mostrarParking () {
		...
		System.out.println("");
		//System.out.println("---COCHES ESPERANDO: " + cocheEsperando);
		//System.out.println("---CAMIONES ESPERANDO: " + camionEsperando);
